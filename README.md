...
| **Анализ результатов пари на спорт** [(GitHub)](https://github.com/Arkady303/bets) | Выбор гипотез, подготовка данных и статистический анализ результатов пари на спорт с помощью *Bootstrap*. | `pandas`, `numpy`, `seaborn`, `matplotlib`|
